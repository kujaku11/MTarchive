...
project = u'mth5'
copyright = u'2018, US Geological Survey'
author = u'Jared Peacock'
...
latex_documents = [
    (master_doc, 'mtpy.tex', u'MTH5 Documentation',
        author, 'manual'),
]
...
man_pages = [
    (master_doc, 'mtpy', u'MTH5 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mth5', u'MTH5 Documentation',
     author, 'mth5', 'One line description of project.',
     'Miscellaneous'),
]
